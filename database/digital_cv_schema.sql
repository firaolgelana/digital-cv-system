...
-- --------------------------------------------------------
-- 2) CV CORE (matches create-cv.html form sections)
-- --------------------------------------------------------
CREATE TABLE IF NOT EXISTS `cvs` (
        `id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
        `student_id` INT UNSIGNED NOT NULL,
        `internal_title` VARCHAR(120) NOT NULL COMMENT 'inp-cv-title',
        `full_name` VARCHAR(120) NULL COMMENT 'inp-name snapshot',
        `contact_email` VARCHAR(150) NULL COMMENT 'inp-email snapshot',
        `contact_phone` VARCHAR(30) NULL COMMENT 'inp-phone snapshot',
        `location_address` VARCHAR(180) NULL COMMENT 'inp-address snapshot',
        `target_headline` VARCHAR(150) NULL COMMENT 'inp-headline',
        `summary` TEXT NULL COMMENT 'inp-summary',
        `portfolio_link` VARCHAR(255) NULL COMMENT 'inp-portfolio',
...
CREATE TABLE IF NOT EXISTS `cv_social_links` (
        ...
        `platform_name` VARCHAR(60) NOT NULL COMMENT 'LinkedIn, GitHub, X',
...
CREATE TABLE IF NOT EXISTS `cv_education` (
        ...
        `start_period` VARCHAR(50) NULL COMMENT 'Year or Month YYYY',
        `end_period` VARCHAR(50) NULL COMMENT 'Year, Month YYYY, or Present',
        `sort_order` INT UNSIGNED NOT NULL DEFAULT 1,
        `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `cv_experience` (
        `id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
        `cv_id` INT UNSIGNED NOT NULL,
        `role_company` VARCHAR(180) NOT NULL COMMENT 'Role + Company from frontend',
...
-- --------------------------------------------------------
-- 3) REVIEW, EVALUATION, QR, AND TRACKING
-- --------------------------------------------------------
